...
size_t come_string_len(const come_string_t* a);
...
size_t come_string_count(const come_string_t* a, const char* sub);
...
size_t come_string_list_len(const come_string_list_t* list);
